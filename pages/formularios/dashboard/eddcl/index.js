      ...
      <div>
        ...
        <div className="">
          <div className=" items-center text-center font-bold">
            <div className="flex ">
              ...
              <div className="text-right pl-2">{EDDCLheaders.length}</div>
            </div>
            <div className="flex ">
        ...
        <div className="grid grid-cols-3 gap-5">
          {/* {cabecera2.map((item) => (
            ...
            >
              <div className="rounded px-5 py-16 text-2xl bg-blue-300 text-gray-800 hover:bg-blue-200 hover:text-black">
                {item.id}
                <h1 className="font-bold">{item.productoname}</h1> <br />
                {item.datenow}
                <div className="flex justify-between items-center text-center">
                  <br />
                  {item.tapadora} - {item.producto}
                </div>
              </div>
            </Link>
          ))} */}
